...
# app
bot_token = os.environ.get("TOKEN", "5557689251:AAGQDOGofqbaSp4CtAUX6gAJMwU33vLmMWA") 
api_hash = os.environ.get("HASH", "a0bc2084a5665791dbbe222cb4897a49") 
api_id = os.environ.get("ID", "10982914")
app = Client("my_bot",api_id=api_id, api_hash=api_hash,bot_token=bot_token)


# optionals
auth = os.environ.get("AUTH", "1934595699,5072965573")
...
def echo(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    if not checkuser(message):
        app.send_message(message.chat.id, '__You are either not **Authorized** or **Banned**__, Contact to Arpit Chauhan to get authorized.',reply_to_message_id=message.id,reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("Contact from here", url="https://t.me/ArpitChauhan0209")]]))
        return
    ...
    reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("Contact with Owner from here", url="https://t.me/ArpitChauhan0209")]]))
